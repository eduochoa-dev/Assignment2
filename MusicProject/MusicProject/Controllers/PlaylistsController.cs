...
namespace MusicProject.Controllers
{
    public class PlaylistsController : Controller
    {
        ...
        {
            var musicDbContext = _context.Playlists.Include(p => p.User);
        ...
        public async Task<IActionResult> Create([Bind("IdPlaylist,PlaylistName,UserId")] Playlist playlist)
        {
            ...
            ViewData["UserId"] = new SelectList(_context.Users, "IdUser", "IdUser", playlist.UserId);
            return View(playlist);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPlaylist,PlaylistName,UserId")] Playlist playlist)
        {
