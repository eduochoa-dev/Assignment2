...
namespace MusicProject.Controllers
{
    public class ArtistsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdArtist,ArtistName")] Artist artist)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdArtist,ArtistName")] Artist artist)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!ArtistExists(artist.IdArtist))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
          return (_context.Artists?.Any(e => e.IdArtist == id)).GetValueOrDefault();
        }
    }
}
